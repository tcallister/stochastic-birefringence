...
results = compute_likelihood_grids(zs_merger,dRdV_delayed,clippingFunction=toClip,kappaGridSize=400,baselines=['HVO3'])

# Create hdf5 file and write posterior samples
hfile = h5py.File('./../data/fixed_rate_delayedSFR_HVO3.hdf','w')
